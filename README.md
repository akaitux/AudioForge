...
```bash
curl -fsSL https://raw.githubusercontent.com/akaitux/AudioForge/steamos-3.8-volume-routing-fix/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/akaitux/AudioForge/steamos-3.8-volume-routing-fix/install_prerelease.sh | bash
```
